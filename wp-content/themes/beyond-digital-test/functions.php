...
function footer_styles() {
    if( !is_admin() ){
        wp_enqueue_style('slick-style',  get_template_directory_uri() . '/style-slick.css');
    }
};
add_action( 'get_footer', 'footer_styles' );
*/
function loadclient_js()
{
	if( !is_admin() ){
        //added slick.js includes
        wp_enqueue_script('slick-slider-min',   get_template_directory_uri() . '/js/slick.min.js', '', '',true);
        //wp_enqueue_script('slick-slider',   get_template_directory_uri() . '/js/scripts-slick.js', '', '',true);
        wp_enqueue_script('slick-slider-init',   get_template_directory_uri() . '/js/slick_init.js', '', '',true);
        //wp_enqueue_style('slick-style',     get_template_directory_uri() . '/style-slick.css');
        
        }
}
add_filter('init', 'loadclient_js');
